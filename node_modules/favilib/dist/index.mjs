...
async function createScreenshot(sourceset, name, options) {
  ...
  const contents = await sharp(sourceset[0].data).resize(finalWidth, finalHeight, {
    fit: "cover",
    position: "center"
...
class AndroidPlatform extends Platform {
  ...
  async createHtml() {
    ...
    const appNameMetaTag = this.options.name ? `<meta name="application-name" content="${escapeHtml(
      this.options.name
...
class AppleIconPlatform extends Platform {
  ...
  async createHtml() {
    ...
    return [
      ...
      name ? `<meta name="apple-mobile-web-app-title" content="${escapeHtml(
        name
